...
* [User signin and creates a new specific device](users/user_signin_and_creates_a_new_specific_device.markdown)
* [User signin with an existing specific device](users/user_signin_with_an_existing_specific_device.markdown)
