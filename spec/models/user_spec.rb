...
RSpec.describe User, type: :model do
  ...
  describe :can_invite? do
    ...
    context "group subscribers can invite" do
    ...
    context "not owner & subs can't invite" do
  ...
  describe :active_member? do
    ...
    describe "membership exists" do
      ...
      describe "state active" do
        it "return true" do
          membership.activate
          expect(user.active_member? group).to be true
        end
      end
      ...
      describe "state not active" do
        it "return false if kicked" do
          membership.kick
          expect(user.active_member? group).to be false
        end
