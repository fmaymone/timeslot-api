...
resource "Feeds" do
  ...
  get "/v1/feed/user", :redis do
    ...
    describe "Get the users activity feed" do
      ...
      let(:slot) { create(:std_slot_public, :with_media,
                          meta_slot: meta_slot) }
      let(:message) { I18n.t('activity_comment', name: 'You', title: slot.title) }
  ...
  get "/v1/feed/news", :redis do
    ...
    describe "Get an aggregated activity feed" do
      ...
      let(:slot) { create(:std_slot_public, :with_media,
                          meta_slot: meta_slot) }
      let(:message) { "#{actor.username} #{I18n.t('activity_comment')}" }
  ...
  get "/v1/feed/notification", :redis do
    ...
    describe "Get activity notifications" do
      ...
      let(:slot) { create(:std_slot_public, :with_media,
                          meta_slot: meta_slot) }
      let(:message) { I18n.t('activity_comment', name: actor.username, title: slot.title) }
